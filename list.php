...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action="index.php?page=search" class="form-inline my-2 my-lg-0">
        ...
        <div class="row">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary"><?php echo $note['type_id']?></a>
                    <a href="index.php?page=delete&id=<?php echo $note['id']?>">delete</a>
                    <a href="index.php?page=update&id=<?php echo $note['id']?>">update</a>
                </div>
            </div>
        </div>
    </div>
